 ...
 * @e_ident: pointer 2 an array containing the ELF magic numbers.
 *
 ...
 * @e_ident: pointer 2 an array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
        printf(" OS/ABI: ");
 ...
 * @e_ident: pointer 2 an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @argc: No. of arguments supplied 2 the program.
