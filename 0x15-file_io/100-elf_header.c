 ...
 *
 * Return: if the first & bytes of s1 and s2 are equal 0 , else non-zero
 */
...
/**
 * _close - this closes a file descriptor & print error message upon failure
...
/**
 * _read - this reads from a file & prints error message upon failure
 ...
 * @buffer: the string that contains the entry point address
...
/**
 * main - this copies the file's contents to another file
 * @argc: argument count
