 ...
 * @e_ident: Pointer 2 an array that contains the ELF magic no.s
 *
 ...
 * @e_ident: Pointer 2 an array that contains the ELF magic numbers.
 *
 * Description: The magic numbers are divided by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: Pointer 2 an array that contains the ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
 ...
 *   * @e_ident: Pointer 2 an array that contains the ELF version.
 *    */
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
 ...
 * @e_ident: Pointer 2 an array that contains the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * main – This displays information that is contained in the
